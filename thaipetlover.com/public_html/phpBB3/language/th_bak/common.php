...
$lang = array_merge($lang, array(
	...
	'BROWSING_FORUM_GUEST'	=> 'ผู้ที่กำลังใช้งาน: %1$s และ %2$d บุคคลทั่วไป',
	'BROWSING_FORUM_GUESTS'	=> 'ผู้ที่กำลังใช้งาน: %1$s และ %2$d บุคคลทั่วไป',
	'BYTES'					=> 'Bytes',
	...
	'DELETE_COOKIES'		=> 'ลบ cookies ของบอร์ดทั้งหมด',
	...
	'DISPLAY_POSTS'			=> 'แสดงการตอบก่อนนี้',
	'DISPLAY_TOPICS'		=> 'แสดงกระทู้ก่อนนี้',
	...
	'FAQ'					=> 'FAQ',
	'FAQ_EXPLAIN'			=> 'คำถามที่ถูกถามบ่อย',
	'FILENAME'				=> 'Filename',
	'FILESIZE'				=> 'File size',
	'FILEDATE'				=> 'File date',
	...
	'FORUM_INDEX'			=> 'หน้ากระดานข่าวหลัก',
	...
	'HIDDEN_USERS_ZERO_TOTAL'	=> '0 คนที่ไม่แสดงและ ',
	'HIDDEN_USER_ONLINE'		=> '%d hidden user online',
	'HIDDEN_USER_TOTAL'			=> '%d คนที่ไม่แสดงและ ',
	...
	'LAST_POST'							=> 'ตอบล่าสุด',
	'LAST_UPDATED'						=> 'ปรับปรุงข้อมูลล่าสุด',
	...
	'LEGEND'							=> 'Legend',
	'LOCATION'							=> 'ที่อยู่',
	'LOCK_POST'							=> 'ล็อคคำตอบนี้',
	'LOCK_POST_EXPLAIN'					=> 'Prevent editing',
	'LOCK_TOPIC'						=> 'ล็อคกระทู้นี้',
	'LOGIN'								=> 'เข้าระบบ',
	...
	'LOG_ME_IN'							=> 'เข้าระบบอัตโนมัติทุกครั้ง',
	...
	'NA'						=> 'N/A',
	'NEWEST_USER'				=> 'สมาชิกคนล่าสุดคือ <strong>%s</strong>',
	'NEW_MESSAGE'				=> 'ข้อความใหม่',
	'NEW_MESSAGES'				=> 'ข้อความใหม่',
	'NEW_PM'					=> 'ข้อความส่วนตัวใหม <strong>%d</strong> ข้อความ่',
	'NEW_PMS'					=> 'ข้อความส่วนตัวใหม่ <strong>%d</strong> ข้อความ',
	'NEW_POST'					=> 'New post',
	'NEW_POSTS'					=> 'New posts',
	'NEXT'						=> 'หน้าถัดไป',		// Used in pagination
	'NEXT_STEP'					=> 'Next',
	'NEVER'						=> 'Never',
	'NO'						=> 'ไม่ใช่',
	...
	'NO_NEW_PM'					=> 'ข้อความส่วนตัวใหม่ <strong>0</strong> ข้อความ',
	...
	'ONLINE_USERS_TOTAL'		=> 'ผู้ที่กำลังใช้งานทั้งหมด <strong>%d</strong> คน :: ',
	'ONLINE_USERS_ZERO_TOTAL'	=> 'ผู้ที่กำลังใช้งานทั้งหมด <strong>0</strong> คน :: ',
	'ONLINE_USER_TOTAL'			=> 'ผู้ที่กำลังใช้งานทั้งหมด <strong>%d</strong> คน :: ',
	'OPTIONS'					=> 'Options',

	'PAGE_OF'				=> 'หน้าที่ <strong>%1$d</strong> จากทั้งหมด <strong>%2$d</strong> หน้า',
	'PASSWORD'				=> 'รหัสผ่าน',
	...
	'POST_DAY'				=> '%.2f คำตอบต่อวัน',
	'POST_DETAILS'			=> 'Post details',
	'POST_NEW_TOPIC'		=> 'Post new topic',
	'POST_PCT'				=> '%.2f%% ของคำตอบทั้งหมด',
	'POST_PCT_ACTIVE'		=> '%.2f%% ของจำนวนคำตอบทั้งหมด',
	'POST_PCT_ACTIVE_OWN'	=> '%.2f%% ของจำนวนคำตอบของคุณ',
	'POST_REPLY'			=> 'ตอบกลับ',
	'POST_REPORTED'			=> 'Click to view report',
	'POST_SUBJECT'			=> 'Post subject',
	'POST_TIME'				=> 'เวลาที่โพสท์',
	'POST_TOPIC'			=> 'สร้างกระทู้ใหม่',
	'POST_UNAPPROVED'		=> 'This post is waiting for approval',
	'PREVIEW'				=> 'ดูตัวอย่าง',
	'PREVIOUS'				=> 'หน้าก่อนหน้า',		// Used in pagination
	...
	'REASON'					=> 'Reason',
	'RECORD_ONLINE_USERS'		=> 'จำนวนของผู้ที่เข้ามาใช้งานมากที่สุด <strong>%1$s</strong> คน เมื่อ %2$s',
	'REDIRECT'					=> 'Redirect',
	'REDIRECTS'					=> 'Total redirects',
	'REGISTER'					=> 'สมัครสมาชิก',
	'REGISTERED_USERS'			=> 'สมาชิก:',
	'REG_USERS_ONLINE'			=> 'There are %d registered users and ',
	'REG_USERS_TOTAL'			=> '%d คนที่เป็นสมาชิก, ',
	'REG_USERS_ZERO_ONLINE'		=> 'There are 0 registered users and ',
	'REG_USERS_ZERO_TOTAL'		=> '0 คนที่เป็นสมาชิก, ',
	'REG_USER_ONLINE'			=> 'There is %d registered user and ',
	'REG_USER_TOTAL'			=> '%d คนที่เป็นสมาชิก, ',
	'REMOVE'					=> 'Remove',
	...
	'RETURN_INDEX'				=> '%sกลับไปยังหน้ากระดานข่าวหลัก%s',
	'RETURN_FORUM'				=> '%sReturn to the forum last visited%s',
	'RETURN_PAGE'				=> '%sกลับไปยังหน้าก่อนหน้านี้%s',
	'RETURN_TOPIC'				=> '%sReturn to the topic last visited%s',
	'RETURN_TO'					=> 'กลับไปยัง',
	'RULES_ATTACH_CAN'			=> 'คุณ <strong>สามารถ</strong> แนบไฟล์ในกระดานข่าวนี้',
	'RULES_ATTACH_CANNOT'		=> 'คุณ <strong>ไม่สามารถ</strong> แนบไฟล์ในกระดานข่าวนี้',
	'RULES_DELETE_CAN'			=> 'คุณ <strong>สามารถ</strong> ลบการตอบกระทู้ของคุณในกระดานนี้',
	'RULES_DELETE_CANNOT'		=> 'คุณ <strong>ไม่สามารถ</strong> ลบการตอบกระทู้ของคุณในกระดานนี้',
	'RULES_DOWNLOAD_CAN'		=> 'คุณ <strong>สามารถ</strong> ดาวน์โหลดไฟล์ในกระดานข่าวนี้',
	'RULES_DOWNLOAD_CANNOT'		=> 'คุณ <strong>ไม่สามารถ</strong> ดาวน์โหลดไฟล์ในกระดานข่าวนี้',
	'RULES_EDIT_CAN'			=> 'คุณ <strong>สามารถ</strong> แก้ไขการตอบกระทู้ของคุณในกระดานนี้',
	'RULES_EDIT_CANNOT'			=> 'คุณ <strong>ไม่สามารถ</strong> แก้ไขการตอบกระทู้ของคุณในกระดานนี',
	'RULES_LOCK_CAN'			=> 'คุณ <strong>สามารถ</strong> ล็อคกระทู้ของคุณในกระดานนี้',
	'RULES_LOCK_CANNOT'			=> 'คุณ <strong>ไม่สามารถ</strong> ล็อคกระทู้ของคุณในกระดานนี้',
	'RULES_POST_CAN'			=> 'คุณ <strong>สามารถ</strong> ตั้งกระทู้ใหม่ในกระดานนี้',
	'RULES_POST_CANNOT'			=> 'คุณ <strong>ไม่สามารถ</strong> ตั้งกระทู้ใหม่ในกระดานนี้',
	'RULES_REPLY_CAN'			=> 'คุณ <strong>สามารถ</strong> ตอบกระทู้ในกระดานนี้',
	'RULES_REPLY_CANNOT'		=> 'คุณ <strong>ไม่สามารถ</strong> ตอบกระทู้ในกระดานนี้',
	'RULES_VOTE_CAN'			=> 'คุณ <strong>สามารถ</strong> ลงคะแนนในแบบสำรวจในกระดานนี้',
	'RULES_VOTE_CANNOT'			=> 'คุณ <strong>ไม่สามารถ</strong> ลงคะแนนในแบบสำรวจในกระดานนี้',

	'SEARCH'					=> 'ค้นหา',
	'SEARCH_MINI'				=> 'ค้นหา…',
	'SEARCH_ADV'				=> 'ค้นหาแบบพิเศษ',
	'SEARCH_ADV_EXPLAIN'		=> 'View the advanced search options',
	'SEARCH_KEYWORDS'			=> 'Search for keywords',
	'SEARCHING_FORUMS'			=> 'กำลังค้นหาในกระดาน',
	'SEARCH_ACTIVE_TOPICS'		=> 'ดูกระทู้ที่มีความเคลื่อนไหวล่าสุด',
	'SEARCH_FOR'				=> 'Search for',
	'SEARCH_FORUM'				=> 'ค้นหาในกระดานนี้…',	
	'SEARCH_NEW'				=> 'ดูกระทู้ใหม่ตั้งแต่เข้ามาครั้งสุดท้าย',
	'SEARCH_POSTS_BY'			=> 'ค้นหาที่โพสท์โดย',
	'SEARCH_SELF'				=> 'ดูกระทู้ของคุณ',
	'SEARCH_TOPIC'				=> 'ค้นหาในกระทู้นี้…',
	'SEARCH_UNANSWERED'			=> 'ดูกระทู้ที่ยังไม่มีการตอบ',
	'SECONDS'					=> 'วินาที',
	'SELECT'					=> 'เลือก',
	'SELECT_ALL_CODE'			=> 'เลือกทั้งหมด',
	'SELECT_DESTINATION_FORUM'	=> 'Please select a destination forum',
	'SELECT_FORUM'				=> 'เลือกกระดาน',
	'SEND_EMAIL'				=> 'E-mail',
	...
	'STATISTICS'				=> 'สถิติ',
	'START_WATCHING_FORUM'		=> 'แจ้งเตือนเมื่อมีกระทู้ใหม่ในกระดานนี้',
	'START_WATCHING_TOPIC'		=> 'แจ้งเตือนเมื่อมีการตอบในกระทู้นี้',
	'STOP_WATCHING_FORUM'		=> 'ยกเลิกการแจ้งเตือนเมื่อมีกระทู้ใหม่ในกระดานนี้',
	'STOP_WATCHING_TOPIC'		=> 'ยกเลิกการแจ้งเตือนเมื่อมีการตอบในกระทู้นี้',
	'SUBFORUM'					=> 'Subforum',
	'SUBFORUMS'					=> 'Subforums',
	'SUBJECT'					=> 'หัวข้อ',
	'SUBMIT'					=> 'ส่ง',
	...
	'TOTAL_POSTS'		=> 'จำนวนคำตอบทั้งหมด',
	'TOTAL_POSTS_OTHER'	=> 'จำนวนคำตอบทั้งหมด <strong>%d</strong>',
	'TOTAL_POSTS_ZERO'	=> 'จำนวนคำตอบทั้งหมด <strong>0</strong>',
	'TOPIC_REPORTED'	=> 'This topic has been reported',
	'TOTAL_TOPICS_OTHER'=> 'จำนวนกระทู้ทั้งหมด <strong>%d</strong>',
	'TOTAL_TOPICS_ZERO'	=> 'จำนวนกระทู้ทั้งหมด <strong>0</strong>',
	'TOTAL_USERS_OTHER'	=> 'จำนวนสมาชิกทั้งหมด <strong>%d</strong>',
	'TOTAL_USERS_ZERO'	=> 'จำนวนสมาชิกทั้งหมด <strong>0</strong>',
	...
	'WARNINGS'			=> 'การตักเตือน',
	'WARN_USER'			=> 'ตักเตือนผู้ใช้',
	'WELCOME_SUBJECT'	=> 'ยินดีต้อนรับสู่ %s forums',
	'WEBSITE'			=> 'เว็บไซต์',
	'WHOIS'				=> 'Whois',
	'WHO_IS_ONLINE'		=> 'ผู้ใช้งานในขณะนี้',
	'WRONG_PASSWORD'	=> 'คุณใส่รหัสผ่านไม่ถูกต้อง',
	...
	'YES'				=> 'ใช่',
	'YIM'				=> 'YIM',	
	'YOU_LAST_VISIT'	=> 'คุณเข้ามาครั้งสุดท้ายเมื่อ: %s',
