...
$lang = array_merge($lang, array(
	...
	'DISABLE_MAGIC_URL'			=> 'ไม่ต้องแปลง URL ให้เป็นลิงค์ที่คลิกได้',
	...
	'VIEW_MESSAGE'				=> '%sดูข้อความที่คุณโพสต์%s',
