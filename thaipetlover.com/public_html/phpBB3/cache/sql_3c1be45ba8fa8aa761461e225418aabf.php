...
/* SELECT image_name, image_filename, image_lang, image_height, image_width FROM phpbb_styles_imageset_data WHERE imageset_id = 1 AND image_filename <> '' AND image_lang IN ('th', '') */

$expired = (time() > 1271868409) ? true : false;
if ($expired) { return; }
